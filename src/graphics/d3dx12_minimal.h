...
struct CD3DX12_HEAP_PROPERTIES : public D3D12_HEAP_PROPERTIES {
    ...
    CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE type, UINT cpuPageProperty = D3D12_CPU_PAGE_PROPERTY_UNKNOWN, UINT memoryPoolPreference = D3D12_MEMORY_POOL_UNKNOWN, UINT creationNodeMask = 1, UINT visibleNodeMask = 1) noexcept {
        Type = type;
