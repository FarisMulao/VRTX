...
struct Vec3 {
    ...
    Vec3 operator+(const Vec3& o) const { return {x_val+o.x_val, y_val+o.y_val, z_val+o.z_val}; }
    Vec3 operator-(const Vec3& o) const { return {x_val-o.x_val, y_val-o.y_val, z_val-o.z_val}; }
    Vec3 operator*(float s) const { return {x_val*s, y_val*s, z_val*s}; }
    Vec3 operator/(float s) const { return {x_val/s, y_val/s, z_val/s}; }
    Vec3 operator-() const { return {-x_val, -y_val, -z_val}; }
    
    Vec3& operator+=(const Vec3& o) { x_val+=o.x_val; y_val+=o.y_val; z_val+=o.z_val; return *this; }
    Vec3& operator-=(const Vec3& o) { x_val-=o.x_val; y_val-=o.y_val; z_val-=o.z_val; return *this; }
    Vec3& operator*=(float s) { x_val*=s; y_val*=s; z_val*=s; return *this; }
    ...
    static Vec3 cross(const Vec3& a, const Vec3& b) {
        return {
            a.y_val*b.z_val - a.z_val*b.y_val,
            a.z_val*b.x_val - a.x_val*b.z_val,
            a.x_val*b.y_val - a.y_val*b.x_val
        };
    }
    
    float lengthSq() const { return x_val*x_val + y_val*y_val + z_val*z_val; }
